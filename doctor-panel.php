...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Software Hospitalar MedSystem </a>
...
.text-primary {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" method="post" action="search.php">
      <input class="form-control mr-sm-2" type="text" placeholder="entrar com contato de numero" aria-label="Buscar" name="contact">
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Bem Vindo &nbsp<?php echo $_SESSION['dname'] ?>  </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list">Painel</a>
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home">Compromissos</a>
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-black no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Ver compromissos</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-black no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> prescrições</h4>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">compromisso ID</th>
                  ...
                  <?php 
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        <button class="btn btn-success">Prescrição</button></a>
                        <?php } else {
        ...
        <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Primeiro Nome</th>
                    <th scope="col">Ultimo Nome</th>
                    <th scope="col">ID De Encontro</th>
                    <th scope="col">Data do encontro</th>
                    <th scope="col">Hora do compromisso</th>
