...
if(isset($_POST['prescribe']) && isset($_POST['pid']) && isset($_POST['ID']) && isset($_POST['appdate']) && isset($_POST['apptime']) && isset($_POST['lname']) && isset($_POST['fname'])){
  ...
  $query=mysqli_query($con,"insert into prestb(doctor,pid,ID,fname,lname,appdate,apptime,disease,allergy,prescription) values ('$doctor','$pid','$ID','$fname','$lname','$appdate','$apptime','$disease','$allergy','$prescription')");
    if($query)
    {
      echo "<script>alert('Prescrição Feita com Sucesso!');</script>";
    }
    else{
      echo "<script>alert('Não foi possível processar sua solicitação. Tente novamente!');</script>";
    }
  // else{
...
<html lang="en">
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #cc9f0d, #000000);
}
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       ...
       <li class="nav-item">
       <a class="nav-link" href="doctor-panel.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Voltar</a>
      </li>
    </ul>
  </div>
</nav>
...
<body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Bem vindo !!! &nbsp<?php echo $doctor ?>
   </h3>
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php">
          ...
          <div class="row">
                  <div class="col-md-4"><label>Doença:</label></div>
                  <div class="col-md-8">
                  <!-- <input type="text" class="form-control" name="disease" required> -->
                  <textarea id="disease" cols="86" rows ="5" name="disease" required></textarea>
                  </div><br><br><br>
                  
                  <div class="col-md-4"><label>Alergia:</label></div>
                  <div class="col-md-8">
                  ...
                  <div class="col-md-4"><label>Prescrição:</label></div>
                  <div class="col-md-8">
